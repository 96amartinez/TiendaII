...
public class VVideojuegosAccion extends JFrame {
	...
	public VVideojuegosAccion(String nick) {
		...
		JLabel lblVideojuegosDeAccion = new JLabel("Videojuegos de Acción");
		panelNorte.add(lblVideojuegosDeAccion);
	...
	private void cargarImagenesPS4() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "PS4", "Acción");
	...
	private void cargarImagenesPS3() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "PS3", "Acción");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
	...
	private void cargarImagenesXBOX() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "XBox", "Acción");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
	...
	private void cargarImagenesGratis() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "Minijuegos", "Acción");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
