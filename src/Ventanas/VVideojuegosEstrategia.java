...
public class VVideojuegosEstrategia extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VVideojuegosEstrategia(String nick) {
		...
		JLabel lblVideojuegosDeEstrategia = new JLabel("Videojuegos De Estrategia");
		panelNorte.add(lblVideojuegosDeEstrategia);
...
panelPS3.addMouseListener(new MouseListener() {
	...
	private void cargarImagenesPS4() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "PS4", "Estrategia");
	...
	private void cargarImagenesPS3() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "PS3", "Estrategia");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
	...
	private void cargarImagenesXBOX() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "XBox", "Estrategia");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
	...
	private void cargarImagenesGratis() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "Minijuegos", "Estrategia");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
