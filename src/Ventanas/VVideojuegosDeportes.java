...
public class VVideojuegosDeportes extends JFrame {
	...
	public VVideojuegosDeportes(String nick) {
		...
		JLabel lblVideojuegosDeDeportes = new JLabel("Videojuegos de Deportes");
		panelNorte.add(lblVideojuegosDeDeportes);
...
panelGratis.addMouseListener(new MouseListener() {
	...
	private void cargarImagenesPS3() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "PS3", "Deportes");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
	...
	private void cargarImagenesXBOX() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "XBox", "Deportes");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
	...
	private void cargarImagenesGratis() {
		ArrayList<String> aRutas = VentanaLogin.bd.obtenerVideojuegosCategoriaPlataformaYTipo("Videojuegos", "Minijuegos", "Deportes");
		for(int i=0;i<aRutas.size();i++) {
			String ruta = aRutas.get(i);
			ImageIcon im = new ImageIcon(ruta);
			int width =250;
